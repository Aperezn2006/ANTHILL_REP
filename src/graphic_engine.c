...
void graphic_engine_paint_zoom(Graphic_engine *ge, Game *game) {
  ...
  */
  ...
  if (space_get_id(space) == 11)
  {
    ...
    screen_area_puts(ge->map, str1);
    sprintf(str1, "      |_|__|               | |                                    | | ");
    if (game_get_character_location(game, 51) == 11 && character_get_health(game_get_character(game, 51)) > 0 && game_get_player_location(game) == 11)
    {
      screen_area_puts(ge->map, str1);
      sprintf(str1, "______|_|__|____ ____ _____| |_________________________ ____ _____| |______ ");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "/\\/\\/\\|__|_|/\\/ /____\\__ \\/| |_________________||_____ /====\\/| __| |\\/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\/|_|__|\\/\\ | __ | \\/\\/| |_________________||_____ |_   |\\| __| |/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "/\\/\\/\\|__|_|/\\/ \\____/ \\/\\/| |_________________||______\\_|  / ____| |\\/\\/\\/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\/|_|__|\\ __/____\\__ \\/| |_________________||_______ |__| ____| |/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "/\\/\\/\\|__|_| /|  \\__/  |\\ \\| |_________________||_______/====\\ ___| |\\/\\/\\/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\/|_|__ | |  |__|  | | | |_________________||_______| _|==| __| |//\\/\\/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "             \\|________|/                               ||_|__|");
      screen_area_puts(ge->map, str1);
    ...
    else if (game_get_player_location(game) == 11 && character_get_health(game_get_character(game, 51)) <= 0)
    {
      screen_area_puts(ge->map, str1);
      sprintf(str1, "______|_|__|_______________| |_________________________ ____ _____| |______ ");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "/\\/\\/\\|__|_|/\\/\\/\\/\\/\\/\\/\\/| |_________________||_____ /====\\/| __| |\\/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\/|_|__|\\/\\/\\/\\/\\/\\/\\/\\| |_________________||_____ |_   |\\| __| |/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "/\\/\\/\\|__|_|/\\/\\/\\/\\/\\/\\/\\/| |_________________||______\\_|  / ____| |\\/\\/\\/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\/|_|__|\\/\\/\\/\\/\\/\\/\\/\\| |_________________||_______ |__| ____| |/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "/\\/\\/\\|__|_|/\\/\\/\\/\\/\\/\\/\\/| |_________________||_______/====\\ ___| |\\/\\/\\/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\/|_|__|\\/\\/\\/\\/\\/\\/\\/\\| |_________________||_______| _|==| __| |//\\/\\/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "                                                        ||_|__|");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "                                                        |=====| ");
  ...
  else if (space_get_id(space) == 2)
  {
    ...
    sprintf(str1, "            || | | |           ___         || | | |                       ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || | | |          /____\\       || | | |              ____     ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || | | |          |^  ;|       || | | |             /====\\/|  ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || | | |   ______ \\ == /       || | | |   _______   |_   |\\|  ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "      ___   || | | | <_______ _|  |_       || | | | <________>  \\_|  /    ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "____/___/|__|| | | |/        /\\____/\\      || | | |/        /|___ |__| ___||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "    |   |   || | | /       /|        |\\    || | | /        /     /====\\   ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || | |/       | |        | |   || | |/        /     | _|==|   ||");
    ...
    sprintf(str1, "            || | /         \\|        |/    || | /        /      ||_|__|   ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || |/________/  |        |     || |/________/       |=====|   ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            ||  ||      ||  |________|     ||  ||      ||        \\===/    ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "                            /__|  |__\\                           ||=|");
  ...
  else if (space_get_id(space) == 3)
  {
    sprintf(str1, "  ");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "_________________");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "\\ \\ \\ \\ \\ \\ \\ \\ \\|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "\\ \\ \\ \\ \\ \\ \\ \\ \\|");
    ...
    sprintf(str1, "\\ \\ \\ \\ \\ \\ \\ \\ \\|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "\\_\\_\\_\\_\\_\\_\\_\\_\\|__               _____               _____      ");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "\\_\\_\\/\\/\\_\\_\\_\\_\\|//|            /     /|            /     /|           ");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "________ ____ ___|/ |         __/     / | ___     __/     / | ___     __");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "----- |\\/====\\ --/  |_______/  /     /__/   /|__/  /     /__/   /|__/  /");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "_____ |/|   _| _/   |      /  /     /  /   /   /  /     /  /   /   /  /  ");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        \\  |_/  |   /     /  /     /  /   /   /  /     /  /   /   /  /   ");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |__|    |  /     /  /     /  /   /   /  /     /  /   /   /  /    ");
    ...
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |=||       /___|     | /___/   /___|     | /___/   /___|     |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |__\\\\      |   |     | |   |   |   |     | |   |   |   |     |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "                       |     |             |     |             |     |");
  ...
  else if (space_get_id(space) == 4)
  {
    ...
    sprintf(str1, "                         | / / /|/ / /|     |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "           ____          | / / /|/_/_/|_____|               ___");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |\\/====\\         | / / / / / /     /|             /__   \\");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |/|   _|         | / / / / /     /  |             |^  \\  |");
    ...
    sprintf(str1, "          |__|           | / / /     /      |       /|     |__|__|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "________ /====\\ _______/ | / /     /        |_____/  |___ /     \\__________");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |==|_ |      /   | /     /         /  ___|   |    |_  | |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |\\_|_||    /_____|_____/         /  /    |  /|   /    |_|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        |=====|    |          |        /  /______|/  |  |    /_/");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "         \\===/     |          |      /    |      |       \\_____/");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "         |=||      |          |    /      |      |          || |");
  ...
  else if (space_get_id(space) == 5)
  {
    ...
    sprintf(str1, "      /     /| / |/  |/     /| / |/  |/     /| / |/  \\  |_/");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "    /____ /  |  /| //____ /  |  /| //____ /  |  /| / |__|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "   |     | / |/  | |     | / |/  | |     | / |/  |  /====\\    ____/|_____");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "   |     |  /| / |/|     |  /| / |/|     |  /| / |/ |==|_ | /  __/ |    /|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "___|     |/  |  /| |     |/  |  /| |     |/  |  /| /|\\_|_||  /  | /   /_||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "   |     | / |/  | |     | / |/  | |     | / |/  |  |===/  /____|/  /   ||");
    screen_area_puts(ge->map, str1);
  ...
  else if (space_get_id(space) == 6)
  {
    ...
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  |             ___   |                   __||__             |___________|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  |__________ /____\\  |                   |      |                   |");
    screen_area_puts(ge->map, str1);
    if (player_get_location(game_get_player(game, 0)) == 6)
    {
    sprintf(str1, "  |__________ |>  <|  |                  |______|                   |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  |           \\::::/  |                 /________\\                  |");
    screen_area_puts(ge->map, str1);
    }
  ...
  else if (space_get_id(space) == 7)
  {
    ...
    sprintf(str1, "  ");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "___________________________________________________________________________");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "/\\/\\/\\/\\/\\___/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "\\/\\/\\/\\/\\/  /|/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\");
    ...
    sprintf(str1, "\\/\\/\\|  ||____/:/\\/\\/\\/\\/\\ /____\\ \\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/");
    screen_area_puts(ge->map, str1);
    if (player_get_location(game_get_player(game, 0)) == 7)
    {
      sprintf(str1, "/\\/\\/|  ||::::\\/\\//\\/\\/\\/\\ |>  <| /\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\|  | / |/\\/\\/\\/\\/\\/\\/ \\::::/ /\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\");
    ...
    else if (player_get_location(game_get_player(game, 1)) == 7)
    {
      sprintf(str1, "/\\/\\/|  ||::::\\/\\//\\/\\/\\/\\ |^  o| /\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "\\/\\/\\|  | / |/\\/\\/\\/\\/\\/\\/ \\ -- / /\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\");
    ...
    if (player_get_location(game_get_player(game, 0)) == 7)
    {
      sprintf(str1, "       |  | |           |=|==01==|=|           __________________________ ");
      screen_area_puts(ge->map, str1);
    }
    else if (player_get_location(game_get_player(game, 1)) == 7)
    {
      sprintf(str1, "       |  | |           |=|==02==|=|           __________________________ ");
      screen_area_puts(ge->map, str1);
    }
    sprintf(str1, "       |  | |____________\\|======|/_____      /_________________________/|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, " ^     |  | |__________   |======|     /     |          ^^             |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "    ^  |  | |         /   \\======/   /");
  ...
  else if (space_get_id(space) == 8)
  {
    ...
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        /_______ /__ ____ ___/ /_/ /|_____/||/_/||/_/||/_/||/_/||/__||____");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "      /_______ /    /____\\  /____/ /      /||/ /||/ /||/ /||/ /|| /");
    screen_area_puts(ge->map, str1);
  ...
  else if (space_get_id(space) == 9)
  {
    ...
    sprintf(str1, " ||__|__|__||__|__|__||__|__|__||__|__|__||__|__|__||__|__|__||__|__|__||");
    screen_area_puts(ge->map, str1);
    if (game_get_character_location(game, 52) == 9 && character_get_health(game_get_character(game, 52)) > 0 && game_get_player_location(game) == 9)
    {
      sprintf(str1, " ||  | ____ |  |  |  ||  |  |  ||  |  |  ||  |  |  ||  |  |  ||  |  |  ||");
      screen_area_puts(ge->map, str1);
      sprintf(str1, " || |\\/====\\   |  |  ||  |  |  ||  |  |  ||  |  |  ||  |  |  ||  |  |  ||");
      screen_area_puts(ge->map, str1);
      sprintf(str1, " || |/|   _|  _|__|__||__|__|__||__|__|__||__|__|__||__|__|__||__|__|__||");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "      \\  |_/");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "      |__|                                            __/\\");
    ...
    else if (game_get_character_location(game, 52) != 9 && game_get_character_location(game, 52) == 9 && character_get_health(game_get_character(game, 52)) > 0)
    {
      sprintf(str1, "                                                     __/\\");
      screen_area_puts(ge->map, str1);
      sprintf(str1, "                                                  __/'   |");
  ...
  else if (space_get_id(space) == 12)
  {
    ...
    sprintf(str1, "       :\\.||  ./:                                 /  **    /");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "________:\\|| ./:_________________________________| *\\ / * |_________________");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "/\\/\\/\\/\\/\\||./:\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\**  /  */\\/\\/\\/\\/\\/\\/\\_/|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "__________||_____________________________________/ * \\**/______________// |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "       ___||_____       |\\/====\\             __ | *\\ *|               // /|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "     /    ||    /|      |/|   _|           /__/\\ | *|/               // / |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "    /          / |        \\  |_/          /___\\//__/                // / /|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "   /          /  |        |__|           /_|_|_/|                  // / |/|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  /__________/   |       /====\\          |     |/                 // / / /|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  |  ______  |   |      |==|_ |          |_____/                 // /  |/ |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  | |      | |  /       |\\_|_||                                 // /    |/|");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  | |     .| | /        |=====|                                // /       |");
    ...
    sprintf(str1, "  | |      | |/          \\===/                                // /   /|   |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "  |_|______|_/            |=||                               // /   / /   |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "============================================================// /   / /    |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "_____________________________________________________________|/    |/|    |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "                                                              |   / /     |");
    screen_area_puts(ge->map, str1);
  }
  else if (space_get_id(space) == 124)
  {
    sprintf(str1, "            |       \\             /       /||/ /||/ /||/ /||/ /||/ /||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            |       /            /        /||/ /||/ /||/ /||/ /||/ /||");
    ...
    sprintf(str1, "          /_______ /|                     /||/ /||/ /||/ /||/ /||/ /||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "        /_______ /__ ____ ________________/||/_/||/_/||/_/||/_/||/__||____");
    screen_area_puts(ge->map, str1);
