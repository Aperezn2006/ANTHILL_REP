...
void graphic_engine_paint_zoom(Graphic_engine *ge, Game *game) {
  ...
  */
  ...
  screen_area_puts(ge->map, str1);
    ...
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "_________________|/ |         __/     / | ___     __/     / | ___     __");
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "-----------------/  |_______/__/     /__/   /|__/__/     /__/   /|__/__/");
    screen_area_puts(ge->map, str1); 
    ...
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "       |  | |__________________________      /_________________________/|");
    screen_area_puts(ge->map, str1); 
    ...
    sprintf(str1, "               /|        | / / /     /      |       /| ");
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "_____________/  |______/ | / /     /        |_____/  |_____________________");
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "            |   /____/   | /     /         /  ___|   |");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            |  /   /_____|_____/         /  /    |  /|");
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "            |/_____|          |        /  /______|/  |");
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "            |      |          |      /    |      |");
    screen_area_puts(ge->map, str1); 
    sprintf(str1, "            |      |          |    /      |      |");
  ...
  else if (space_get_id(space) == 11)
  {
    ...
    sprintf(str1, "            || | | |                       || | | |                       ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || | | |   _______             || | | |   _______             ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "      ___   || | | | <________>      ___   || | | | <________>      ___   ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "____/___/|__|| | | |/        /|____/___/|__|| | | |/        /|____/___/|__||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "    |   |   || | | /        /      |   |   || | | /        /      |   |   ||");
    screen_area_puts(ge->map, str1);
    sprintf(str1, "            || | |/        /               || | |/        /               ||");
