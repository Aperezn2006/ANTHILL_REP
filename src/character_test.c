...
int main(int argc, char **argv) {
  ...
  if (all || test == 6) test1_character_get_location();
  if (all || test == 7) test2_character_get_location();
  if (all || test == 8) test1_character_set_location();
  if (all || test == 9) test2_character_set_location();
  if (all || test == 10) test1_character_get_name();
  if (all || test == 11) test2_character_get_name();
  if (all || test == 12) test1_character_set_name();
  if (all || test == 13) test2_character_set_name();
  if (all || test == 14) test1_character_get_description();
  if (all || test == 15) test2_character_get_description();
  if (all || test == 16) test1_character_set_description();
  if (all || test == 17) test2_character_set_description();
  ...
  if (all || test == 22) test1_decrease_health();
  if (all || test == 23) test2_decrease_health();
  ...
  if (all || test == 32) test1_character_print();
  if (all || test == 33) test2_character_print();
...
void test1_character_get_location() {
  Character *c;
  c = character_create(1);
  character_set_location(c, 1);
  PRINT_TEST_RESULT(character_get_location(c) == 1);
  character_destroy(c);
}
...
void test1_character_set_location() {
  Character *c;
  c = character_create(1);
  PRINT_TEST_RESULT(character_set_location(c, 1) == OK);
  character_destroy(c);
}

void test2_character_set_location() {
  Character *c = NULL;
  PRINT_TEST_RESULT(character_set_location(c, 1) == ERROR);
}
